...
public class JdbcConnection {
	...
	public static void update(Connection connection,int software_id) throws SQLException {
		PreparedStatement pstmt = connection.prepareStatement("update  softwaredetails set  softwarename=? where softwareid=?");
	...
	public static void view(Connection connection,int software_id) throws SQLException {
		PreparedStatement pstmt = connection.prepareStatement("select * from softwaredetails where softwareid=?");
		int id=obj.nextInt();
		pstmt.setInt(1,id);
